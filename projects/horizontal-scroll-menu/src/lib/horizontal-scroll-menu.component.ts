...
@Component({
  ...
  template: `
    <nav class="d-flex" *ngIf="items?.length" [ngClass]="background">
      <div *ngIf="!hideNav" class="control d-flex align-items-center justify-content-center mousePointer" (click)="scrollLeft()">
      ...
      <div *ngIf="!hideNav" class="control d-flex justify-content-center align-items-center mousePointer" (click)="scrollRight()">
